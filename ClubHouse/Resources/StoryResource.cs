...
namespace ClubHouse.Resources
{
    internal class StoryResource : Resource<Story, int>, IStoryResource
    {
        ...
        public Task<IReadOnlyList<Story>> Create(IEnumerable<Story> stories) => base.Create<Story, IReadOnlyList<Story>>(stories);

        public Task<IReadOnlyList<Story>> Update(IEnumerable<Story> stories) => base.Update<Story, IReadOnlyList<Story>>(stories);
